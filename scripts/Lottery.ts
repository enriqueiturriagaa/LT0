...
async function initContracts() {
  ...
  const lotteryContractAddress = contract.address;
  console.log(`Lottery contract address is:${lotteryContractAddress}`);
  const tokenAddress = await contract.paymentToken();
  console.log(`Lottery contract address is:${tokenAddress}`);
