...
export type { LotteryToken } from "./contracts/Token.sol/LotteryToken";
export { LotteryToken__factory } from "./factories/contracts/Token.sol/LotteryToken__factory";
export type { Ballot } from "./contracts/TokenizedBallot.sol/Ballot";
export { Ballot__factory } from "./factories/contracts/TokenizedBallot.sol/Ballot__factory";
